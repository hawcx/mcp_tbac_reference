...
```bash
git clone https://github.com/hawcx/hx_mcp_tbac
cd hx_mcp_tbac
pnpm install
```
...
```
[demo] TBAC reference implementation (SEP 2026-04-20-r40)
...
## Run the r40 widening-attack demo

This is the ground-truth regression test for r40 §8.1. It fails closed at BOTH the TQS mint-gate and the RS cascade Step 13:
