...
Thanks for considering a contribution to `mcp_tbac_reference`.

## Clean-room boundary

This implementation is **clean-room** relative to Hawcx's proprietary HAAP codebase. When contributing:

1. Work from [`spec/0000-tbac-task-based-access-control-r41.md`](spec/0000-tbac-task-based-access-control-r41.md) only.
