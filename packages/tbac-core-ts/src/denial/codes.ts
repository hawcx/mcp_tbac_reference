...
export const DENIAL_CODES = {
  ...
  // §6 table — intent verification (Step 13.7)
  INTENT_INTEGRITY_FAILED: 'INTENT_INTEGRITY_FAILED',
  INTENT_MISMATCH: 'INTENT_MISMATCH',
  INTENT_PAYLOAD_TOO_LARGE: 'INTENT_PAYLOAD_TOO_LARGE',
} as const;
...
export const FAILED_CHECKS = {
  ...
  // §6 table — intent verification failed_check values
  INTENT_HASH_CHECK: 'INTENT_HASH_CHECK',
  INTENT_ACTION_COMPARISON: 'INTENT_ACTION_COMPARISON',
